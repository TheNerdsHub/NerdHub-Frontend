...
import { FaSearch, FaUserFriends, FaTags, FaSortAmountDown, FaFilter, FaChevronRight, FaChevronLeft, FaChevronUp, FaChevronDown } from 'react-icons/fa';
    ...
    <div className="games-page-wrapper">
      ...
      <div className="main-content">
        <aside className={`games-sidebar${sidebarOpen ? ' open' : ' collapsed'}`}>
          ...
          <button 
            className={`sidebar-toggle-btn-mobile ${sidebarOpen ? 'open' : 'collapsed'}`}
            onClick={() => setSidebarOpen(!sidebarOpen)} 
            aria-label={sidebarOpen ? "Collapse sidebar" : "Expand sidebar"}
          >
